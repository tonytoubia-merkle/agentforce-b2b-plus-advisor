...
function buildTraits(profile: CustomerProfile): string[] {
  ...
  if (profile.beautyProfile?.industry) {
    traits.push(profile.beautyProfile.industry);
  }
  ...
  if (profile.beautyProfile?.primaryApplications?.length) {
    traits.push(profile.beautyProfile.primaryApplications[0]);
  }
